 ...
 */
/** @brief Stop timer, prescaler 000 --> STOP */
#define TIM2_stop()           TCCR0A &= ~((1<<CS12) | (1<<CS11) | (1<<CS10));
/** @brief Set overflow 16ms, prescaler 001 --> 1 */
#define TIM2_overflow_16u()   TCCR0A &= ~((1<<CS12) | (1<<CS11)); TCCR0A |= (1<<CS10);
/** @brief Set overflow 128u, prescaler 010 --> 8 */
#define TIM2_overflow_128u()  TCCR0A &= ~((1<<CS12) | (1<<CS10)); TCCR0A |= (1<<CS11);
/** @brief Set overflow 1m, prescaler 011 --> 64 */
#define TIM2_overflow_1m() TCCR0A &= ~(1<<CS12); TCCR0A |= (1<<CS11) | (1<<CS10);
/** @brief Set overflow 4m, prescaler 100 --> 256 */
#define TIM2_overflow_4m()    TCCR0A &= ~((1<<CS11) | (1<<CS10)); TCCR0A |= (1<<CS12);
/** @brief Set overflow 16m, prescaler // 101 --> 1024 */
#define TIM2_overflow_16m()    TCCR0A &= ~(1<<CS11); TCCR0A |= (1<<CS12) | (1<<CS10);
